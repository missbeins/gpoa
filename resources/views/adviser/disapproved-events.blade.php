                            ...
                            @if ($disapproved_events->isNotEmpty())
                                @foreach ($disapproved_events as $disapproved_event)
                                    <tr>
                                        ...
                                        <td>{{ $disapproved_event->organization_name }}</td>
                                        <td>{{ $disapproved_event->venue }} / {{ date_format(date_create($disapproved_event->time), 'H : i a')}}</td>
                                        <td>                                            
                                            <a href="{{ route('adviser.events.show', [$disapproved_event->upcoming_event_id, $disapproved_event->organization_id]) }}"class="btn btn-secondary btn-sm mt-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Display event details">Details</a>
                                            ...
                                            @include('adviser.includes.reason')
                                        </td>
                                    </tr>
                                @endforeach
                            @else
