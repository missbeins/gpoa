                            ...
                            @if ($approved_events->isNotEmpty())
                                @foreach ($approved_events as $approved_event)
                                    <tr>
                                        ...
                                        <td>                                            
                                            <a href="{{ route('director.events.show', [$approved_event->upcoming_event_id, $approved_event->organization_id]) }}"class="btn btn-secondary btn-sm mt-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Display event details">Details</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
