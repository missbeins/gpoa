 <!-- Modal -->
 <div class="modal fade" id="director-approval-form{{ $upcoming_event->upcoming_event_id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('director.director.approved', $upcoming_event->upcoming_event_id) }}" enctype="multipart/form-data"  method="POST">
            @csrf
