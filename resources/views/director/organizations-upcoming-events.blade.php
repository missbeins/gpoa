...
@section('content')
    ...
    <div class="mt-3">
        ...
        <div class="row">
            <form class="col-md-4 input-group mb-2" style="width:33%" action="{{ route('director.searchEvents') }}" method="GET">
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">        
                @if (isset($upcoming_events))
                    <table class="table table-light table-sm table-striped table-hover table-responsive" id="upcoming">
                        <thead>
                            <tr>
...
@section('scripts')
    <script type="module">
        ...
        window.addEventListener('DOMContentLoaded', event => {
            const dataTable = new simpleDatatables.DataTable("#upcoming", {
                perPage: 10,
                searchable: true,
                labels: {
