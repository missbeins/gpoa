                ...
                <nav aria-label="breadcrumb align-items-center">
                    <ol class="breadcrumb justify-content-center ">
                        <li class="breadcrumb-item">
                            <a href="{{route('director.director.home')}}" class="text-decoration-none">Organization's Events</a>
                        </li>
                ...
                <div class="card-body">
                    <form class="row g-3">
                        ...
                        <div class="col-md-4 mb-1">
                            ...
                            value="{{ old('partnerships') }}@isset($upcoming_event){{ $upcoming_event->head_organization }}@endisset" required
