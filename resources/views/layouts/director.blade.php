    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">
                ...
                @can('is-director')
                    <a class="second-text brand" href="{{ route('director.director.home') }}"><i
            ...
            <div class="list-group list-group-flush my-3" id="myList">
                @can('is-director')
                    ...
                    <div class="dropdown-container">
                            <a href="{{ route('director.director.home') }}">All events</a>
                        @foreach(\App\Models\organization::all() as $organization)
                           <a href="{{ route('director.organization-events', $organization->organization_id) }}" value="{{ $organization->organization_id}}">{{ $organization->organization_acronym }}</a>
                        @endforeach
                    </div>
                    <button class="dropdown-btn second-text fw-bold"><i
                    ...
                    <div class="dropdown-container">
                       <a href="{{ route('director.approvedEvents') }}">Approved Events</a>
                       <a href="{{ route('director.disapprovedEvent') }}">Disapproved Events</a>
                    </div>
                @endcan
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{ route('director.profile') }}"><i
