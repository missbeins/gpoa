                            ...
                            @if ($disapproved_events->isNotEmpty())
                                @foreach ($disapproved_events as $disapproved_event)
                                    <tr>
                                        ...
                                        <td>                                            
                                            <a href="{{ route('officer.events.show', [$disapproved_event->upcoming_event_id, $disapproved_event->organization_id]) }}"class="btn btn-secondary btn-sm mt-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Display event details">Details</a>
                                            ...
                                            @include('officer.includes.reason')
                                        </td>
                                    </tr>
                                @endforeach
                            @else
