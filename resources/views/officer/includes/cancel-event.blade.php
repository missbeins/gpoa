 <!-- Modal -->
 <div class="modal fade" id="cancel-event-form{{ $upcoming_event->upcoming_event_id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Cancel Event</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="{{ route('officer.cancel-event', [$upcoming_event->upcoming_event_id , $upcoming_event->organization_id]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="modal-body">
                <h5 class="mb-3">Do you really want to cancel this event?</h5>
                ...
                <div class="input-group input-group-sm mb-3">
                    <p class="text-danger">Note: Before cancelling this event, please make sure to inform your partners for this event.</p>
                </div>
            </div>
