<!-- Modal -->
<form action="{{ route('officer.presentation-pdf') }}" method="POST">
    @csrf
    <div class="modal fade" id="initial-pdf" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Generate initial PDF</h5>
